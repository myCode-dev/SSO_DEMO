...
$(function() {
    ...
    modeSwitch.addEventListener("click", () => {
        ...
        const time = document.querySelector("#header div");
        body.classList.toggle("dark");
        header.classList.toggle("dark");
        listTitles.forEach((listTitle) => {
            listTitle.classList.toggle("dark");
        })
    ...
    var $scroll = $("<div>").addClass("scroll").appendTo($container);
    var $items = $("<div>").addClass("cards").appendTo($scroll);
